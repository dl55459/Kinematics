...
# -----------------------------------------------------------------------------------------------------------------------------
    ...
    def manualMoveAngles(self, data):
        ...
        phi = float(msg.phi) if hasattr(msg, 'phi') else float(msg.x)
        alpha = float(msg.alpha) if hasattr(msg, 'alpha') else float(msg.y)
        theta = float(msg.theta) if hasattr(msg, 'theta') else float(msg.z)
