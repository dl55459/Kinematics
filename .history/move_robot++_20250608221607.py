...
class prarobClientNode(Node):
    def __init__(self):
        ...
        self.manual_sub = self.create_subscription(JointAngles, '/manual_angles', self.manualMoveAngles, 10)
        self.manual_sub = self.create_subscription(Point, '/manual/xy', self.manualMovePoints, 10)
# -----------------------------------------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------------------------------------------------------
