...
L1z, L3x, L3z, LEx, LEz = sp.symbols("L1z, L3x, L3z, LEx, LEz", real = True) # Lengths in mm
phi, theta = sp.symbols("phi theta", real = True) # Rotaion in rad
subsL = {L1z : 41.9, L3x : 190, L3z : -0.55, LEx : 189, LEz : 39.35} # Links lengths
