...
d3_true = 1
# forward → position
x_pos, y_pos, z_pos = forward_kinematics(q1_true, q3_true, d1, d2, d3_true, d4)
print("Forward kinematics gives X, Y, Z =", np.round([x_pos, y_pos, z_pos], 4))
# inverse → back to joints
q1_sol, q2_sol, q3_sol, d3_sol = inverse_kinematics(x_pos, y_pos, z_pos, d1, d2, d4, elbow="down", )
