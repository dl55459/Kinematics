...
# -----------------------------------------------------------------------------------------------------------------------------
    ...
    def manualMoveAngles(self, data):
        ...
        try:
            ...
            phi = float(data.phi) if hasattr(data, 'phi') else float(msg.x)
            alpha = float(data.alpha) if hasattr(data, 'alpha') else float(msg.y)
            theta = float(data.theta) if hasattr(data, 'theta') else float(msg.z)
