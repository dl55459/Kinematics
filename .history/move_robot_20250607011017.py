...
def activePos(flag):
    ...
    if flag == 1:
        phiActive = DEG2RAD(0)
        alphaActive = DEG2RAD(np.pi) # Active angle for motor 2 (pitch)
        thetaActive = DEG2RAD(0)
    else:
        phiActive = DEG2RAD(0) # Idle angle for motor 1
        alphaActive = DEG2RAD(np.pi/2) # Idle angle for motor 2
        thetaActive = DEG2RAD(3*np.pi/2) # Idle angle for motor 3
...
L1z = 41.9/1000 # z-component of distance between base and motor 1
L3x = 190/1000 # x-component of distance between motor 1 and motor 3
L3z = -0.55/1000 # z-component of distance between motor 1 and motor 3
LEx = 189/1000 # x-component of distance between motor 3 and end effector
LEz = 39.35/1000 # z-component of distance between motor 3 and end effector
...
xDesired = 10/1000 # Desired x coordinate
yDesired = 10/1000 # Desired y coordinate
LM1M3 = 190/1000 # x-component of distance between motor 1 and motor 3
LM3EE = 189/1000 # x-component of distance between motor 3 and end effector

# Working area limits
xLowerWS = -25.487/1000
xUpperWS = 324.513/1000
xLowerB = 25.487/1000
xUpperB = 124.513/1000
yLowerWS = -175/1000
yUpperWS = 175/1000
yLowerB = -75/1000
yUpperB = 75/1000
