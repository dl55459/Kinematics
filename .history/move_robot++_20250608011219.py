...
def apply_brot_offset(desired_angle_deg):
    # Convert desired angle to motor command with 180° offset
    motor_zero = 180  # Physical 0° is at motor's 180°
    return (desired_angle_deg + motor_zero) % 360

# Example usage:
desired_angle = 0  # Want to point forward (motor's 180° position)
command_angle = apply_brot_offset(desired_angle)  # Returns 180
